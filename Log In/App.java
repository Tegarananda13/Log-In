...
public class App {
    public static void main(String[] args) {
        ...
        String namaKasir = " Tegar ";
        String userName = "tegarananda";
        String inputUserName;
        String password = "tegarganteng123";
        ...
        System.out.println("SELAMAT DATANG DI TEGAR MANTAP MART");
            System.out.println("========================");
            ...
            if (eCaptcha == false) {
                ...
                if (eUserName == false && ePassword == false) {
                    ...
                    try {
                        ...
                        System.out.println("");
                        System.out.println("\t\033[1m\033[31mTegar Mart\033[0m");
